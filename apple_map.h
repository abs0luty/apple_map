/**
 * @author		Adi Salimgereyev
 * @brief			C library, that implements a hashmap using FNV-1a hashing algorithm.
 * @date			8/17/2023
 * @version 	0.2.0
 */
 ...
 * @version		0.1.0
 */
typedef struct apple_map apple_map;
 ...
 * @version					0.1.0
 */
size_t apple_map_len(apple_map *map);
 ...
 * @version						0.1.0
 */
void apple_map_free(apple_map *map);
